    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Edit About US Section 3</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Edit About US Section 3</h5>
              ...
              <form action="{{ url('admin/save_edt_sec3v') }}"  onsubmit="return validate_slider();" method="post" enctype="multipart/form-data" id="course_form">
                ...
                <input type="hidden" id="ausec3_id" name="ausec3_id" value="{{ $ausec3->id }}">
                <div class="row mb-3">
                  <label for="image" class="col-sm-2 col-form-label">Image</label>
                  <div class="col-sm-10">
                    <input type="hidden" name="image" value="{{ $ausec3->image }}" class="form-control" id="image">
                    <input type="file" name="new_ausec3" class="form-control" id="image" accept=".jpeg, .jpg, .png">
                    <span style="color: red;font-size: 13px;">( <b>Note :</b> Image Dimensions must be 570.94 x 480 px )</span>
                    <div><img src="{{ url('assets/upload_aboutus/'.$ausec3->image)}}" alt="ausec3 Image" height="300" width="100%"></div>
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text"  value="{{ $ausec3->title }}" name="title" oninput="wordCount2()" maxlength="50" size="50" class="form-control" id="title" >
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                  <textarea class="ckeditor form-control content_text" id="txtarea" oninput="wordCount()" maxlength="700" size="700" rows="8" cols="45" name="description" rows="5"><?php echo $ausec3->description; ?></textarea>
