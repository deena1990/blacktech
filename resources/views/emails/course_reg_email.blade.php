                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td style="padding:0 20px;">
                              <p>This is a confirmation email that you have been registered a Course successfully from <span style="color:#0877bd;">BlackTECH</span>.</p>
                           </td>
                        </tr>
                     </tbody>
                  </table>
                     ...
                     <tbody>
                        <tr>
                           <td style="background-color:#fff;text-align:left;padding:0 20px;">
                              <p style="margin-top:10px;margin-bottom:0;">I am so glad to confirm you for your choosen Course.</p>
                              <!--  -->
                           </td>
                        </tr>
                        <tr>
