                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td style="padding:0 20px;">
                              <p>This is a confirmation email that you have been registered an Event successfully from<span style="color:#0877bd;">BlackTECH</span>.</p>
                           </td>
                        </tr>
                     </tbody>
                  </table>
                     ...
                     <tbody>
                        <tr>
                           <td style="background-color:#fff;text-align:left;padding:0 20px;">
                              <p style="margin-top:10px;margin-bottom:0;">I am so glad to confirm you for your choosen Event.</p>&emsp;
                              <li style="list-style: none;">Event Weblink :- <a href="{{ $event_wblink }}" target="_blank">{{ $event_wblink }}</a></li> 
                           </td>
                        </tr>
                        <tr>
                           <td style="padding:0 20px;">
                              <p style="color:#0877BD"></p>
                           </td>
                        </tr>
                        <tr>
                           <td style="padding:0 20px;">
